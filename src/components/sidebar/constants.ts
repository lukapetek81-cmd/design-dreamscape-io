import { Zap, Coins, Wheat, TrendingUp, Beef, Coffee, Package, Newspaper, Moon, Sun, Monitor, Briefcase, Settings, BarChart3, Star, Filter, Calendar, Calculator, MessageSquare, Lightbulb, GraduationCap, Users, Clock, Heart, GitCompare, Activity, Wifi } from "lucide-react";
...
export const MARKET_TOOLS: MarketTool[] = [
  ...
  { id: "ibkr-live-data", label: "IBKR Live Data", icon: Wifi, color: "bg-purple-50 dark:bg-purple-950/20 border-purple-200 dark:border-purple-800 text-purple-600 dark:text-purple-400", path: "/ibkr-live-data" },
