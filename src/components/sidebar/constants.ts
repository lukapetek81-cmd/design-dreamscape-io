...
export const MARKET_TOOLS: MarketTool[] = [
  ...
  { id: "watchlists", label: "Watchlists", icon: Star, color: "bg-purple-50 dark:bg-purple-950/20 border-purple-200 dark:border-purple-800 text-purple-600 dark:text-purple-400", path: "/watchlists" },
