...
export const ACTIVITY_TOOLS: MarketTool[] = [
  { id: "synthetic-trading", label: "Synthetic Trading", icon: CircleDollarSign, color: "bg-teal-50 dark:bg-teal-950/20 border-teal-200 dark:border-teal-800 text-teal-600 dark:text-teal-400", path: "/synthetic-trading" },
